...
struct Color {
    ...
    static let red            = UIColor(red:0.965, green:0.267, blue:0.220, alpha:1.000)
    
    
    static let bgLightGay     = UIColor(white: 0.97, alpha: 1)
    ...
    static let textLightGray   = UIColor(white: 0.4, alpha: 1)
